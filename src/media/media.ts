...
export const MEDIA = {
  ...
  parchment: {
    ...
    shapes: ['sheet', 'torn'],
    damage: { water: 0.5, tears: 0.3, burns: 0.3, folds: 0.4, holes: 0.3, blots: 0.25, foxing: 0.4 },
    obliterate: 'blot',
    holes: 'worm',
  },
  papyrus: {
    ...
    shapes: ['torn', 'sheet'],
    damage: { holes: 0.7, fraying: 0.7, tears: 0.5, darkening: 0.5, water: 0.2, blots: 0.2 },
    obliterate: 'hole',
    grain: 0,
    holes: 'lacuna',
  },
